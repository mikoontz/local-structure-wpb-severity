...
ground_trees <- 
  ...
  map(.f = function(current_site) {
    current_plot_location <-
      st_read(paste0("data/data_output/site_data/", current_site, "/", current_site, "_plot-locations/", current_site, "_plot-locations.shp"), quiet = TRUE) %>% 
      st_zm() %>% 
      dplyr::arrange(id) %>% 
...
ttops_summary <- foreach(i = seq_along(all_validation_plots), .combine = rbind) %dopar% {
  ...
  current_las <- suppressWarnings(suppressMessages(lidR::readLAS(paste0(current_dir, current_site, "_plot-remote-data/", current_plot, "_normalized-point-cloud.las"))))
  ...
  lastrees_li2(current_las, dt1 = 1.4, dt2 = 1.4, R = 0, Zu = 15, hmin = min_height, speed_up = 10)

  # crowns_li2_dt1_1.4_dt2_1.4_zu_15_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.4_dt2_1.4_zu_15_R_0_speedUp_10 <-
    current_las@data %>%
  ...
  #
  lidR::lastrees_li2(current_las, dt1 = 1.5, dt2 = 2, R = 0, Zu = 15, hmin = min_height, speed_up = 10)
  ...
  ttops_li2_dt1_1.5_dt2_2.0_zu_15_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 2, R = 0, Zu = 15, hmin = min_height, speed_up = 10)

  # crowns_li2_dt1_1.0_dt2_2.0_zu_15_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_2.0_zu_15_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 2, R = 0, Zu = 20, hmin = min_height, speed_up = 10)
  
  # crowns_li2_dt1_1.0_dt2_2.0_zu_20_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_2.0_zu_20_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 1.5, R = 0, Zu = 25, hmin = min_height, speed_up = 10)
  
  # crowns_li2_dt1_1.0_dt2_1.5_zu_25_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_1.5_zu_25_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 1.5, R = 0, Zu = 20, hmin = min_height, speed_up = 10)
  
  # crowns_li2_dt1_1.0_dt2_1.5_zu_20_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_1.5_zu_20_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 1.4, R = 0, Zu = 20, hmin = min_height, speed_up = 10)
  
  # crowns_li2_dt1_1.0_dt2_1.4_zu_20_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_1.4_zu_20_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 1.4, R = 0, Zu = 25, hmin = min_height, speed_up = 10)
  
  # crowns_li2_dt1_1.0_dt2_1.4_zu_25_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_1.4_zu_25_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 1.3, R = 0, Zu = 20, hmin = min_height, speed_up = 10)
  
  # crowns_li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 1.0, R = 0, Zu = 20, hmin = min_height, speed_up = 10)
  
  # crowns_li2_dt1_1.0_dt2_1.0_zu_20_R_0_speedUp_10 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_1.0_zu_20_R_0_speedUp_10 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  lidR::lastrees_li2(current_las, dt1 = 1.0, dt2 = 1.3, R = 0, Zu = 20, hmin = min_height, speed_up = 20)
  
  # crowns_li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_20 <-
  #   current_las %>%
  #   as.spatial() %>%
  #   st_as_sf(coords = c("X", "Y"),
  #            crs = proj4string(current_chm)) %>%
  ...
  ttops_li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_20 <-
    current_las@data %>%
    dplyr::group_by(treeID) %>%
    dplyr::filter(Z == max(Z)) %>%
    dplyr::ungroup() %>%
  ...
  crowns_watershed_tol_3_ext_0.5 <-
    lidR::lastrees_watershed(chm = current_chm, th_tree = min_height, tol = 3, ext = 0.5 * round((1 / res(current_chm)[1])), extra = TRUE) %>%
    APfun::APpolygonize() %>%
    st_as_sf() %>%
    rename(treeID = DN) %>%
    group_by(treeID) %>%
  ...
  ttops_watershed_tol_3_ext_0.5 <-
    current_chm %>%
    raster::extract(y = crowns_watershed_tol_3_ext_0.5, cellnumbers = TRUE, df = TRUE) %>%
   ...
   crowns_watershed_tol_1_ext_0.5 <-
    lidR::lastrees_watershed(chm = current_chm, th_tree = min_height, tol = 1, ext = 0.5 * round((1 / res(current_chm)[1])), extra = TRUE) %>%
    APfun::APpolygonize() %>%
    st_as_sf() %>%
    rename(treeID = DN) %>%
    group_by(treeID) %>%
  ...
  ttops_watershed_tol_1_ext_0.5 <-
    current_chm %>%
    raster::extract(y = crowns_watershed_tol_1_ext_0.5, cellnumbers = TRUE, df = TRUE) %>%
    rename(treeID = ID, height = layer) %>%
    group_by(treeID) %>%
    filter(height == max(height)) %>%
    ungroup() %>%
  ...
  crowns_watershed_tol_1_ext_1.0 <-
    lidR::lastrees_watershed(chm = current_chm, th_tree = min_height, tol = 1, ext = 1 * round((1 / res(current_chm)[1])), extra = TRUE) %>%
    APfun::APpolygonize() %>%
    st_as_sf() %>%
    rename(treeID = DN) %>%
    group_by(treeID) %>%
  ...
  ttops_watershed_tol_1_ext_1.0 <-
    current_chm %>%
    raster::extract(y = crowns_watershed_tol_1_ext_1.0, cellnumbers = TRUE, df = TRUE) %>%
    rename(treeID = ID, height = layer) %>%
    group_by(treeID) %>%
    filter(height == max(height)) %>%
    ungroup() %>%
  ...
  ttops <-
    list(
      ...
      li2_dt1_1.4_dt2_1.4_zu_15_R_0_speedUp_10 = ttops_li2_dt1_1.4_dt2_1.4_zu_15_R_0_speedUp_10,
      li2_dt1_1.5_dt2_2.0_zu_15_R_0_speedUp_10 = ttops_li2_dt1_1.5_dt2_2.0_zu_15_R_0_speedUp_10,
      li2_dt1_1.0_dt2_2.0_zu_15_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_2.0_zu_15_R_0_speedUp_10,
      li2_dt1_1.0_dt2_2.0_zu_20_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_2.0_zu_20_R_0_speedUp_10,
      li2_dt1_1.0_dt2_1.5_zu_25_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_1.5_zu_25_R_0_speedUp_10,
      li2_dt1_1.0_dt2_1.5_zu_20_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_1.5_zu_20_R_0_speedUp_10,
      li2_dt1_1.0_dt2_1.4_zu_20_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_1.4_zu_20_R_0_speedUp_10,
      li2_dt1_1.0_dt2_1.4_zu_25_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_1.4_zu_25_R_0_speedUp_10,
      li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_10,
      li2_dt1_1.0_dt2_1.0_zu_20_R_0_speedUp_10 = ttops_li2_dt1_1.0_dt2_1.0_zu_20_R_0_speedUp_10,
      li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_20 = ttops_li2_dt1_1.0_dt2_1.3_zu_20_R_0_speedUp_20,
