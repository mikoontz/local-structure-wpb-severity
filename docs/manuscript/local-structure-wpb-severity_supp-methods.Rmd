...
$$
\Delta_{height} = \beta_0 + X_{height}\beta_1 + X_{live}\beta_2 + X_{height}X_{live}\beta_3 + \epsilon
$$
...
![`r fig_nums(name = "fig-halfeye")`](../../figures/effect-sizes-halfeye_uncalibrated.png)
