...
site_characteristics <- 
  ...
  dplyr::mutate(`% tree mortality\n(aerial/ground)` = paste(sprintf("%0.0f", air_prop_mortality * 100), sprintf("%0.0f", ground_prop_mortality * 100), sep = "/"),
                `Density\n(tpha; aerial/ground)` = paste(sprintf("%0.0f", air_tpha_total), sprintf("%0.0f", ground_tpha_total), sep = "/")) %>% 
  dplyr::rename(`CWD\n(mm)` = site_cwd,
