...
included a separate approximate Gaussian Process term per site of the interaction between the x- and y-position of each cell using the `gp()` function in the `brms` package [@burkner2017] with 3 basis functions.
