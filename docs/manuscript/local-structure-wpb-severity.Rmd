...
We validated the segmentation and classification with data from 160 coincident field plots (each 0.041 ha in area) throughout the 32 sites, with the caveat that dead trees were all classified as ponderosa pine. 
