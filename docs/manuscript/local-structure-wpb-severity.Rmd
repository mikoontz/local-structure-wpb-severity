...
Finally, we estimated the basal area of each tree from their photogrammetry-derived height using species-specific simple linear regressions of the relationship between height and DBH as measured in the coincident field plots from @fettig2019.
...
### Weak positive main effect of CWD

We found only a relatively weak positive effect of site-level CWD on ponderosa pine mortality rate.
