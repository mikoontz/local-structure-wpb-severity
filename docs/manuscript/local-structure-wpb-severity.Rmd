...
```{r algorithm_summary_print, echo = FALSE, include = TRUE}
kable(algorithm_summary_print, format = "pandoc", caption = "Algorithm name, number of parameter sets tested for each algorithm, and references.")
```
