...
Further, a century of fire suppression policy has enabled forests to grow into dense stands, which can also make them more vulnerable to bark beetles [@fettig2012b]. 
This combination of environmental conditions and forest structural characteristics led to tree mortality events of unprecedented size in the driest, most biomass-rich forests across the state [@asner2016; @young2017]. 
However, broad-scale analyses can only offer a partial explanation for the strong latitudinal and elevational gradients of observed tree mortality [@young2017].

Bark beetles can amplify tree mortality dynamics against a background of stressful environmental conditions [@raffa2008; @boone2011]

The mechanism linking hot, dry conditions to tree susceptibility to bark beetle colonization is often attributed directly to tree physiology [@bentz2010; @kolb2016], while the link to forest structure is multifaceted [@fettig2012b].
...
Under severe water stress, many trees no longer have the resources available to mount a defense [@boone2011; @kolb2016] and thus prolonged drought can often trigger increased bark beetle-induced tree mortality as average tree vigor declines [@bentz2010]. 
