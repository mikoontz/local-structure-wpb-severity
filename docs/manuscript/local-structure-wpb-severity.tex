...
\caption{Point cloud from Pix4D}
\end{figure}
...
\caption{Tree top detection}
\end{figure}

\begin{figure}
\centering
\includegraphics{../../figures/eldo_3k_3_crowns.png}
\caption{Crown segmentation}
\end{figure}

\begin{figure}
\centering
\includegraphics{../../figures/eldo_3k_3_live_dead.png}
\caption{Live/dead classification}
\end{figure}

\begin{figure}
\centering
\includegraphics{../../figures/eldo_3k_3_host_nonhost.png}
\caption{Host/non-host classification}
\end{figure}

\begin{figure}
\centering
\includegraphics{../../figures/effect-sizes-halfeye.png}
\caption{Halfeye plot showing posterior distributions of the effect
sizes for the model}
\end{figure}

\begin{figure}
\centering
\includegraphics{../../figures/pipo_tpha_qmd_cwd_interaction_raster.png}
\caption{Raster version of model results showing the primary influence
of Ponderosa pine structure on the probability of ponderosa pine
mortality, and the interaction across climatic water deficit}
\end{figure}

\begin{figure}
\centering
\includegraphics{../../figures/pipo_tpha_qmd_cwd_interaction.png}
\caption{Line version with credible intervals showing primary influence
of Ponderosa pine structure on the probability of ponderosa pine
mortality, and the interaction across climatic water deficit}
\end{figure}
...
We found no main effect of climatic water deficit on the probability of
ponderosa pine mortality within each 20m x 20m cell.

We found a strong effect of ponderosa pine local density, accounting for
quadratic mean diameter, with greater ponderosa pine density increasing
the probability of ponderosa pine mortality. Conversely, we found a
generally negative effect of quadratic mean diameter of ponderosa pine
on the probability of ponderosa mortality, suggesting that the western
pine beetle attacked smaller trees, on average. There was a strong
positive interaction between the climatic water deficit and ponderosa
pine quadratic mean diameter, such that larger trees were more likely to
increase the probability of ponderosa mortality in hotter, drier sites.
...
spatial covariance process). But suggest that this could be a meaningful
and quantifiable
