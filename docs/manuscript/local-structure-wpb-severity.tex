...
Date report generated: April 06, 2019
...
\caption{The orthomosaic for each site is generated with the Structure
from Motion (SfM) processing, showing a top-down view of the whole
survey area such that distances between objects in the scene are
preserved and can be measured. This is a cropped example of an
orthomosaic showing the orange X placed at exactly the plot center prior
to flight.}
\end{figure}
