...
\section{Effect of local host density and size on forest insect severity
depends on climatic water
deficit}\label{effect-of-local-host-density-and-size-on-forest-insect-severity-depends-on-climatic-water-deficit}
...
Date report generated: April 05, 2019
...
\begin{figure}
\centering
\includegraphics{../../figures/study-geographic-extent-inset.png}
\caption{Geographic extent of the study.}
\end{figure}
