# This is an alternative version of the 03 script that takes some extra steps to deal with idiosyncracies 
# in 3 sites. These steps would not be part of the typical workflow-- for that, see the 03_ script.
...
# In order to create the site-bounds_privacy.geoJSON file, I manually edited the vector file in QGIS

# mission_footprint_privacy <- st_read(here::here("data/data_drone/L0/mission-footprint/site-bounds/stan_3k_2_site-bounds_privacy.geoJSON"))
# 
# x3_exif_data <-
